...
<template>
  <main>
      <SubCategorySlider v-for="category in currentCategory.subCategories" :category-id="currentCategory.id" :id="category.id" :favorites="favoritesIds"  :title="category.title" :slides="category.clothes" @update="refresh" :small="true"/>
  </main>
</template>
